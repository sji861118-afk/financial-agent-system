...
- [2026-04-16] **회계 감수 에이전트**: Excel 생성 전 BS 등식, IS 논리, 필수 계정 누락, 비율 이상치 등 자동 검증. 결과를 API 응답에 포함
...
- 커밋: ce96a53, 63c5133, 0e9c574, 7683261, 1866e39, b011a9e, 2b86e4e, 3363a60
- Vercel 프로덕션 배포 8회 모두 `● Ready` 확인
