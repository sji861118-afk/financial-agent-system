...
const PUBLIC_PATHS = ["/login", "/api/auth/login", "/api/auth/logout", "/docx-gen.html", "/api/review/upload-and-generate", "/api/dart/health", "/api/dart/diag-da", "/api/dart/diag-fetch"];
